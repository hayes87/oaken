...
$Shaders = @("Basic.vert", "Basic.frag", "Mesh.vert", "Mesh.frag", "MeshInstanced.vert", "MeshInstanced.frag", "MeshInstancedForwardPlus.frag", "Line.vert", "Line.frag", "Fullscreen.vert", "ToneMapping.frag", "DepthOnly.vert", "DepthOnly.frag", "LightCulling.comp")
